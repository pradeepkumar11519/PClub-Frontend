...
export default function Login_And_Signup() {
  const {invert} = useContext(Context)
    useEffect(()=>{
        $(document).ready(function() {
            ...
            $(document).on("click", ".demo__menu-item:not(.js-menuBtn)", function() {
              ...
              $(document).off("click", ".demo__content", closeNotFocusedMenu);
              setTimeout(function() {
                $(".demo__menu")[0].class = $(".demo__menu")[0].class.replace(/\bpage-active-.*\b/gi, "");
    ...
    return (
      <div className='!bg-[#1f2029] !overflow-hidden'>
        <div className={`mt-20  overflow-hidden bg-[#1f2029] w-full text-white absolute  ${invert} px-10  sm:px-auto`}>
            <div className="h-full w-full ">
                <div className="h-full">
                    <div className="h-full">
                        <div className="col-12 w-full  text-center align-self-center py-5">
